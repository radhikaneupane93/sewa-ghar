    ...
    <div className="bg-gray-100 py-10 px-4 sm:px-6 lg:px-8 mt-24">
      <div className="work-section-wrapper">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          {[...Array(3)].map((_, index) => (
            <div key={index} className="testimonial-section-bottom bg-white p-6 rounded-lg shadow-md">
              <img src={ProfilePic} alt="Profile" className="rounded-full mx-auto w-24 h-24 mb-4" />
